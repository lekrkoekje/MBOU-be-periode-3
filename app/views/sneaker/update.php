        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SneakerController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="gewicht" type="number" min="0" max="9999" step="0.01" class="form-control <?= isset($data['errors']['gewicht']) ? 'is-invalid' : ''; ?>" id="gewicht" value="<?= $_POST['gewicht'] ?? $data['sneaker']->Gewicht ?? ''; ?>">
